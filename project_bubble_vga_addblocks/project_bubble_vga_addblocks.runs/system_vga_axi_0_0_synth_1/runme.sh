...
HD_PWD='C:/Users/Karma/Documents/workspace/final_project/project_bubble_vga_addblocks/project_bubble_vga_addblocks.runs/system_vga_axi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_vga_axi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_vga_axi_0_0.tcl
