...
# module references:
# vga_axi, nopll_mic_block, stream_grabber
...
proc create_hier_cell_mic_block { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -type clk mic_clk
  create_bd_pin -dir I mic_data_in
  create_bd_pin -dir O mic_lr_sel
  ...
  # Create port connections
  connect_bd_net -net mic_data_in_1 [get_bd_pins mic_data_in] [get_bd_pins nopll_mic_block_0/mic_data_in]
  connect_bd_net -net nopll_mic_block_0_mic_clk [get_bd_pins mic_clk] [get_bd_pins nopll_mic_block_0/mic_clk]
  connect_bd_net -net nopll_mic_block_0_mic_lr_sel [get_bd_pins mic_lr_sel] [get_bd_pins nopll_mic_block_0/mic_lr_sel]
...
CONFIG.C_INTERRUPT_PRESENT {1} \
  ...
  # Create instance: vga_axi_0, and set properties
  set block_name vga_axi
  set block_cell_name vga_axi_0
  if { [catch {set vga_axi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vga_axi_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /vga_axi_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M09_AXI [get_bd_intf_pins axi_quad_spi_0/AXI_LITE] [get_bd_intf_pins microblaze_0_axi_periph/M09_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M10_AXI [get_bd_intf_pins mic_block/s_axi_cpu] [get_bd_intf_pins microblaze_0_axi_periph/M10_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI] [get_bd_intf_pins vga_axi_0/S_AXI]
  ...
  connect_bd_net -net axi_quad_spi_0_ss_o [get_bd_ports ACL_CSN] [get_bd_pins axi_quad_spi_0/ss_o]
  ...
  connect_bd_net -net io1_i_1 [get_bd_ports ACL_MISO] [get_bd_pins axi_quad_spi_0/io1_i]
  ...
  connect_bd_net -net vga_axi_0_blue [get_bd_ports blue] [get_bd_pins vga_axi_0/blue]
  connect_bd_net -net vga_axi_0_green [get_bd_ports green] [get_bd_pins vga_axi_0/green]
  connect_bd_net -net vga_axi_0_hsync [get_bd_ports hsync] [get_bd_pins vga_axi_0/hsync]
  connect_bd_net -net vga_axi_0_red [get_bd_ports red] [get_bd_pins vga_axi_0/red]
  connect_bd_net -net vga_axi_0_vsync [get_bd_ports vsync] [get_bd_pins vga_axi_0/vsync]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A30000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs vga_axi_0/S_AXI/reg0] SEG_vga_axi_0_reg0
